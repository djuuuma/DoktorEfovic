...
const SERVICE_OPTIONS: { value: string; label: string }[] = [
  { value: 'viniri', label: 'Keramički viniri' },
  { value: 'dizajn', label: 'Digitalno planiranje osmijeha' },
  { value: 'implant', label: 'Implantološka rehabilitacija' },
  { value: 'general', label: 'Opća konzultacija / prvi pregled' },
];
...
export default function Concierge() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (!url) {
      setSubmitError(
        'Online slanje trenutačno nije podešeno. Pozovite +387 33 000 000 ili pišite na studio@smile.art.',
      );
      return;
    }
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-transparent border-b border-sage/30 py-3 text-2xl text-pearl font-heading focus:outline-none focus:border-gold transition-colors placeholder:text-sage/40"
                  value={formData.name}
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  name="service"
                  className="w-full bg-transparent border-b border-sage/30 py-3 text-2xl text-pearl font-heading focus:outline-none focus:border-gold transition-colors appearance-none cursor-pointer"
              ...
              <motion.button
                ...
                className="w-full py-6 bg-gold text-bg uppercase tracking-[0.2em] font-body font-bold text-sm hover:bg-gold-bright transition-colors disabled:opacity-50 disabled:pointer-events-none"
              >
